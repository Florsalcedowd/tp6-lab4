<template>
  <b-container class="mt-5">
    <b-row>
      ...
      <b-col>
        <p class="cantidadVendida">{{instrumentoEncontrado.cantidadVendida}} vendidos</p>
        <h3 class="tituloDescripcion">{{instrumentoEncontrado.instrumento}}</h3>
        ...
        <div v-else>
          <p
            class="envioPago"
          >Costo de Envio Interior de Argentina: ${{instrumentoEncontrado.costoEnvio}}</p>
        </div>
        <br />
